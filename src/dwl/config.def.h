...
static const char *const autostart[] = {
	"wbg", "/home/sh/wall/city.jpg", NULL,
	"sakura", NULL,
        NULL /* terminate */
};
...
static const char *menucmd[] = { "dmenu-wl_run", "-fn", "TerminessTTF Nerd Font", "-nb", "#080808", "-nf", "#f9f5d7", "-sb", "#202020", "-sf", "#f9f5d7", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_m,          setmfact,       {.f = +0.05} },
	{ MODKEY,                    XKB_KEY_y,          incihgaps,      {.i = +1 } },
	{ MODKEY,                    XKB_KEY_d,          incihgaps,      {.i = -1 } },

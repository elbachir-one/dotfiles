...
static const int systraypinningfailfirst = 1;   /* 1: if pinning fails, display systray on the first monitor, False: display systray on last*/
static const int showsystray        = 1;   /* 0 means no systray */
static const int startwithgaps[]    = { 4 };	/* 1 means gaps are used by default, this can be customized for each tag */
...
static const char *colors[][4]        = {
	...
	[SchemeSel]       = { col_gray4, col_cyan1,  col_gray2, col_cyan2 },
...
static const char *const autostart[] = {
	...
	"slstatus", NULL,
    "cbatticon", NULL,
	"feh", "--bg-fill", "/home/sh/wall/anime_landscape.jpg", NULL,
	"xhidecursor", NULL,
...
static const Rule rules[] = {
    ...
    {"st",                  NULL,           "newsboat",       1 << 9, 	    False,       0,         -1,       -1},
    {"qutebrowser", 	    NULL,           NULL, 	          1 << 3, 	    False,       0,         -1,       -1},
    {"Zathura", 	        NULL,           NULL, 	          1 << 3, 	    False,       0,         -1,       -1},
    {"feh", 	            NULL,           NULL, 	          1 << 3, 	    False,       0,         -1,       -1},
